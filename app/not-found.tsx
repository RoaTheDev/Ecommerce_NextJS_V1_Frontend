...
function SaplingSVG() {
    return (
        <svg viewBox="0 0 500 300" width="100%" height="100%" style={{ maxWidth: '400px' }}>
            ...
            <ellipse cx="250" cy="150" rx="70" ry="80" fill="hsl(32, 32%, 41%, 0.15)" stroke="hsl(32, 32%, 41%)" strokeWidth="1.5" />


            <path d="M180,120 C170,100 170,80 190,70 C210,60 230,80 250,70 C270,60 290,60 310,70 C330,80 330,100 320,120"
            ...
            <path d="M150,180 C170,160 180,190 170,210" stroke="hsl(149, 41%, 39%)" strokeWidth="2" fill="hsl(148, 58%, 55%, 0.6)" />
            <path d="M350,180 C330,160 320,190 330,210" stroke="hsl(149, 41%, 39%)" strokeWidth="2" fill="hsl(148, 58%, 55%, 0.6)" />
