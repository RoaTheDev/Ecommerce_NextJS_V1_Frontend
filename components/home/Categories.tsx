            ...
            <div className="container mx-auto px-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-3 gap-8">
                    <div className="relative rounded-lg overflow-hidden h-64 group">
                        <img src="/lib/data/placeholder/400/300" alt="Clothing" className="w-full h-full object-cover transition-transform group-hover:scale-105 duration-300" />
                    ...
                    <div className="relative rounded-lg overflow-hidden h-64 group">
                        <img src="/lib/data/placeholder/400/300" alt="Accessories" className="w-full h-full object-cover transition-transform group-hover:scale-105 duration-300" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#212121] to-transparent opacity-60"></div>
                        <div className="absolute bottom-0 left-0 p-6">
                    ...
                    <div className="relative rounded-lg overflow-hidden h-64 group">
                        <img src="/lib/data/placeholder/400/300" alt="Collectibles" className="w-full h-full object-cover transition-transform group-hover:scale-105 duration-300" />
                        <div className="absolute inset-0 bg-gradient-to-t from-[#212121] to-transparent opacity-60"></div>
                        <div className="absolute bottom-0 left-0 p-6">
